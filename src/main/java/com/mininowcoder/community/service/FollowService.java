...
public class FollowService implements CommunityConstant {
    ...
    public boolean hasFollowed(int userId, int entityType, int entityId) {
        String followeeKey = RedisKeyUtil.getFolloweeKey(userId, entityType);
        return redisTemplate.opsForZSet().score(followeeKey, entityId) != null; // 查到了就说明关注了
    }
    ...
    // 查询某用户的粉丝
    public List<Map<String, Object>> findFollowers(int usedId, int offset, int limit){
        String followerKey = RedisKeyUtil.getFollowerKey(ENTITY_TYPE_USER, usedId);
